...
import com.sankuai.inf.leaf.segment.dao.impl.IDShortAllocDaoImpl;
...
public class IDShortGenServiceTest {
    IDGen idGen;
    ...
    public void before() throws IOException, SQLException {
        ...
        // Config Dao
        IDAllocDao dao = new IDShortAllocDaoImpl(dataSource);
    ...
    public void testGetId() {
        for (int i = 0; i < 100; ++i) {
            Result r = idGen.get("leaf-segment-short-test");
